...
class SmurfTree {
 public:
  ...
  LorentzVector  genPart1_;
  LorentzVector  genPart2_;
  LorentzVector  genPart3_;
  LorentzVector  genPart4_;
 ...
 public:
  ...
  SmurfTree():info_("info","Smurf ntuple"),
    ...
    genPartPtr1_(&genPart1_),genPartPtr2_(&genPart2_),genPartPtr3_(&genPart3_),genPartPtr4_(&genPart4_),
  ...
  void CreateTree(int type = -1){
    ...
    tree_->Branch("genPart1", "ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<double> >", &genPartPtr1_);
    tree_->Branch("genPart2", "ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<double> >", &genPartPtr2_);
    tree_->Branch("genPart3", "ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<double> >", &genPartPtr3_);
    tree_->Branch("genPart4", "ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<double> >", &genPartPtr4_);
  ...
  void InitTree(int type = -1){
    ...
    tree_->SetBranchAddress("genPart1",  	&genPartPtr1_);
    tree_->SetBranchAddress("genPart2",  	&genPartPtr2_);
    tree_->SetBranchAddress("genPart3",  	&genPartPtr3_);
    tree_->SetBranchAddress("genPart4",  	&genPartPtr4_);
  ...
  LorentzVector* genPartPtr1_;
  LorentzVector* genPartPtr2_;
  LorentzVector* genPartPtr3_;
  LorentzVector* genPartPtr4_;
...
SmurfTree::InitVariables(){
  ...
  genlep2McId_   = 0;
  genlep3McId_   = 0;
  genPart1_      = LorentzVector();
  genPart2_      = LorentzVector();
  genPart3_      = LorentzVector();
  genPart4_      = LorentzVector();
