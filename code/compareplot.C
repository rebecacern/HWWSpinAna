...
void compareplot(){
  ...
  for (const int iPlot = 0; iPlot < nPlots; iPlot++){
    ...
    h0[2][iPlot] = (TH1D*) _file0->Get("histo_before_" + cutLabel[iPlot]+"_"+sampleLabel[4]+"_8TeV");
    ...
    h1[2][iPlot] = (TH1D*) _file0->Get("histo_" + cutLabel[iPlot]+"_"+sampleLabel[4]+"_8TeV");
    ...
    leg->AddEntry(h1[2][iPlot], "Old JHU Gen SM sample", "l");
    leg->Draw();
    c1->SaveAs("plots/"+ cutLabel[iPlot]+ "_8TeV.png");
    gPad->SetLogy();
//    c1->SetLogy();
    c1->SaveAs("plots/"+ cutLabel[iPlot]+ "_8TeV_log.png");
