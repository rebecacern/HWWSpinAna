...
void datacardmaker(bool regular = true){
  ...
  char rootFile[300];
  sprintf(rootFile,"hwwof_0j.input_8TeV.root");
  ...
  for (int i = 0; i < np -1; i++) { if (i==11) datacard << "1.360\t"; else datacard << "-\t";}
  datacard << endl;
  ...
  datacard << "UEPS\t\t\t\t\tlnN\t\t";
  for (int i = 0; i < np -1; i++) { if (i<2) datacard << "0.940\t"; else datacard << "-\t";}
  datacard << endl;
  
  datacard << "interf_ggH\t\t\t\tlnN\t\t";
  for (int i = 0; i < np -1; i++) { if (i<2) datacard << "1.000\t"; else datacard << "-\t";}
  datacard << endl;
  
  datacard << "pdf_gg\t\t\t\t\tlnN\t\t";
  for (int i = 0; i < np -1; i++) { if (i<2) datacard << "1.072\t"; else datacard << "-\t";}
  datacard << endl;
    
  datacard << "pdf_qqbar\t\t\t\tlnN\t\t";
  for (int i = 0; i < np -1; i++) { if (i==4 || i==8 || i==9) datacard << "1.040\t"; else datacard << "-\t";}
  datacard << endl;
  
  datacard << "CMS_hww_PDFggWW\t\t\t\tshape\t\t";
  for (int i = 0; i < np -1; i++) { if (i==3) datacard << "1.0\t"; else datacard << "-\t";}
  datacard << endl;
  ...
  for (int i = 0; i < np -1; i++) { if (i<2) datacard << "1.160\t"; else datacard << "-\t";}
  datacard << endl;
  
  datacard << "QCDscale_ggH1in\t\t\t\tlnN\t\t";
  for (int i = 0; i < np -1; i++) { if (i<2) datacard << "0.920\t"; else datacard << "-\t";}
  datacard << endl;
  ...
  for (int i = 0; i < np -1; i++) { if (i==1) datacard << "1.010\t"; else datacard << "-\t";}
  datacard << endl;
  
  datacard << "QCDscale_WW2j\t\t\t\tlnN\t\t";
  for (int i = 0; i < np -1; i++) { if (i==12) datacard << "1.360555\t"; else datacard << "-\t";}
  datacard << endl;
   
  datacard << "QCDscale_VV\t\t\t\tlnN\t\t";
  for (int i = 0; i < np -1; i++) { if (i==4) datacard << "1.040\t"; else datacard << "-\t";}
  datacard << endl;
  
  datacard << "QCDscale_Vgamma\t\t\t\tlnN\t\t";
  for (int i = 0; i < np -1; i++) { if (i==8) datacard << "1.300\t"; else datacard << "-\t";}
  datacard << endl;
  
  datacard << "CMS_hww2l2n_QCDscale_ggVV\t\tlnN\t\t";
  for (int i = 0; i < np -1; i++) { if (i==3) datacard << "1.300\t"; else datacard << "-\t";}
  datacard << endl;
  ...
  for (int i = 0; i < np -1; i++) { if (i==6) datacard << "1.000\t"; else datacard << "-\t";}
  datacard << endl;
  
  datacard << "CMS_hww_0j_WW_8TeV_SHAPE\t\tlnU\t\t";
  for (int i = 0; i < np -1; i++) { if (i==2) datacard << "2.0\t"; else datacard << "-\t";}
  datacard << endl;
  
  datacard << "CMS_hww_Wg3l\t\t\t\tlnN\t\t";
  for (int i = 0; i < np -1; i++) { if (i==9) datacard << "1.400\t"; else datacard << "-\t";}
  datacard << endl;
  ...
  for (int i = 0; i < np -1; i++) { if (i==4) datacard << "1.0\t"; else datacard << "-\t";}
  datacard << endl;
